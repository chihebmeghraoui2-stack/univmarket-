      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center text-white font-bold text-xs">UM</div>
            <div>
              <p className="font-bold text-sm text-foreground">UnivMarket</p>
              <p className="text-xs text-muted-foreground">Le marche universitaire algerien n1</p>
            </div>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a href="https://wa.me/213656247391" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 px-3 py-2 rounded-lg bg-green-500 hover:bg-green-600 text-white text-xs font-medium transition-colors">
        ...
        <div className="mt-4 pt-4 border-t text-center text-xs text-muted-foreground">
          2024 UnivMarket - Tous droits reserves - Fait avec amour en Algerie
        </div>
      </div>
    </footer>
  );
...
content = content.replace('function Layout()', footer + '\nfunction Layout()');
